...
test('event', () => {
  ...
  expect(coder.encodeTopics(['cfxtest:000j6hb7h40j6hb7h40j6hb7h40j6hb7h4mrga5njc', null]))
  ...
  expect([...coder.decodeLog(log)])
    .toEqual(['cfxtest:000j6hb7h40j6hb7h40j6hb7h40j6hb7h4mrga5njc', JSBI.BigInt(10)]);
});
...
test('event.anonymous', () => {
  ...
  expect([...tuple]).toEqual(['cfxtest:000j6hb7h40j6hb7h40j6hb7h40j6hb7h4mrga5njc', JSBI.BigInt(10)]);

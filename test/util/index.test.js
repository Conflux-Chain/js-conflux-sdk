...
test('alignBuffer', () => {
  ...
  const buffer20 = alignBuffer(format.buffer('0x0123456789012345678901234567890123456789'));
  ...
  const buffer32 = alignBuffer(format.buffer('0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef'));
  ...
  const buffer33 = alignBuffer(format.buffer('0xff0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef'));

...
test('fromCFXToGDrip', () => {
  ...
  expect(unit.fromCFXToGDrip(0.1234567891)).toEqual('123456789.100000000000000000');
});
...
test('fromGDripToDrip', () => {
  ...
  expect(unit.fromGDripToDrip(0.1234567891)).toEqual('123456789.100000000000000000');
});

test('fromDripToGDrip', () => {
  expect(unit.fromDripToGDrip(1000000000)).toEqual('1');
  expect(unit.fromDripToGDrip(-1000000000)).toEqual('-1');
  expect(unit.fromDripToGDrip(1100000000)).toEqual('1.100000000000000000');
});

test('fromGDripToCFX', () => {
  expect(unit.fromGDripToCFX(1000000000)).toEqual('1');
  expect(unit.fromGDripToCFX(-1000000000)).toEqual('-1');
  expect(unit.fromGDripToCFX(1100000000)).toEqual('1.100000000000000000');
});
...
test('fromCFXToDrip', () => {
  ...
  expect(unit.fromCFXToDrip('0.1234567891234567891')).toEqual('123456789123456789.100000000000000000');
});

test('fromDripToCFX', () => {
  expect(unit.fromDripToCFX('1000000000000000000')).toEqual('1');
  expect(unit.fromDripToCFX('-1000000000000000000')).toEqual('-1');
  expect(unit.fromDripToCFX('1100000000000000000')).toEqual('1.100000000000000000');
});

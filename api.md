...
options.defaultGasPrice | string,number | false    |                | The default gas price in drip to use for transactions. (deprecated)
options.defaultGas      | string,number | false    |                | The default maximum gas provided for a transaction. (deprecated)
